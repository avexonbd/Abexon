...
type ActiveTab = "hero" | "notices" | "websites" | "services" | "portfolio" | "testimonials" | "orders" | "team" | "offers" | "ai_assistant" | "headings" | "package_planner" | "why_choose_us" | "contact" | "notifications";
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2 border-b border-purple-500/10 pb-4">
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 leading-relaxed">
                          হোমপেজে প্রদর্শিত "কেন আমাদের বেছে নেবেন" সেকশনের মূল শিরোনাম ও সুবিধাসমূহ কাস্টমাইজ করুন।
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 max-w-5xl">
                      <div className="border border-purple-500/10 bg-[#0e051d] p-4.5 rounded-2xl space-y-4 shadow-sm">
                        <h4 className="text-xs font-bold text-purple-400 uppercase tracking-wider flex items-center gap-2">
                          ...
                          <span>সেকশন ব্যাকগ্রাউন্ড ও শিরোনাম</span>
                        </h4>
